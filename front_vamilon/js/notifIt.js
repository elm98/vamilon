...
function notif(config){
    ...
    var div = "<div id='ui_notifIt'>"+((config.msg) ? config.msg : "")+"</div>";
    ...
    switch(config.type){
        case "error":
            $("#ui_notifIt").addClass("alert alert-danger  text-center");
            break;
        case "success":
            $("#ui_notifIt").addClass("alert alert-success    text-center");
            break;
        case "info":
            $("#ui_notifIt").addClass("alert alert-info  text-center");
            break;
        case "warning":
            $("#ui_notifIt").addClass("alert alert-warning  text-center");
            break;
        default:
            $("#ui_notifIt").addClass("alert alert-primary  text-center");
            break;
    }
    ...
    switch(position){
        case "center":
            $("#ui_notifIt").animate({top: 20});
            break;
        case "right":
            $("#ui_notifIt").animate({right: 0});
            break;
        case "left":
            $("#ui_notifIt").animate({left: 20});
            break;
        default:
            $("#ui_notifIt").animate({right: 0});
            break;
